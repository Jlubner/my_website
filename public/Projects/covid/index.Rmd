...
```{r ,add_image, out.width="100%"}
knitr::include_graphics(here::here("public", "2016ElectionMap_v2.png"))
```
...
library(scales)
ggplot(covid_data_cleaned1, aes(x=age_group,y=death_rate,label=death_rate_label))+
...
ggplot(covid_data_cleaned2, aes(x=age_group,y=death_rate,label=death_rate_label))+
