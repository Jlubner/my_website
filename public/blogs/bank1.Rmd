...
author: "Jason Lubner and Filippo de Bortoli"
date: "15/09/2020"
...
In this report we are analyzing the relation between the employee salary (in pounds) and the 10 other variables. The other variables include: Employee, Education level (“EducLev”); Job grade (“JobGrade”); Year born (“YrHired”); Gender (“Gender”); Performance review (“PerfRev”); IT job (“ITJob”); Years’ experience (“YrsExper”) and Age (“Age”).
...
** Our Final model is log(⁡y)=-7.202197+0.024271x_1+0.106568x_2+0.005429x_3+0.053014x_4+0.010657x_5+0.010299x_6+e
where:
y= Predicted Salary
x_1=Education Level
x_2=Job Grade
